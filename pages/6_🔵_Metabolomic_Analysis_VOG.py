...
def read_csv(url,minclustersize,deepsplit):
     ...
     return df
mgcsts_samples_df = read_csv("Data/vog.mgCSTs.samples.df.csv",minclustersize,deepsplit)
mgCSTs_sort = read_csv("Data/vog_mgCST_sort_color.csv",minclustersize,deepsplit)
...
# col1, col2 = st.columns(2)
# with col1 :
#     mgCST1 = st.slider("GroupA", 1, borne,(1,borne), key='mgCST1')    # this return a tuple (a, b)
# with col2 :
#     mgCST2 = st.slider("GroupB", 1, borne,(1,borne), key='mgCST2')
