...
mgcsts_samples_df = pd.read_csv("Data/vog.mgCSTs.samples.df.csv")
mgCSTs_sort = pd.read_csv("Data/vog_mgCST_sort_color.csv")
...
if heatmap :
    ...
    process = subprocess.Popen(["Rscript", "mgCSTs_VOG_heatmap.R"])#, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
